...
这个 bundle 打包了 Hypo-Research 的 10 个工作流，适合通过 Codex 的 GitHub skill 安装流程一次性安装。
...
本 bundle 内嵌 10 个 skill 文档，位于 `skills/` 目录：
...
可用子命令：`search`, `cite`, `lint`, `verify`, `check`, `meeting`, `glossary`, `init`
